...
(function () {
  ...
  var CSS = [
    ...
    '.dp-play{background:var(--dp-accent,#FF5C4D)} .dp-play:hover{filter:brightness(1.12)}',
    ...
    '.dp-fill{position:absolute;left:0;top:9px;height:4px;width:0;border-radius:99px;background:var(--dp-accent,#FF5C4D)}',
    ...
    '.dp-dots i.done{background:var(--dp-accent,#FF5C4D)} .dp-dots i.now{background:#fff;transform:scale(1.45);box-shadow:0 0 0 4px rgba(255,92,77,.35)}',
    ...
    '.dp-slim i{display:block;height:100%;width:0;background:var(--dp-accent,#FF5C4D)}',

...
WALLS = {
    ...
    'conversion': [                              # Conversions This Month
        ...
        "The last panel is a different book, and a harder call.",
        "Liberator and Newlife to sixty-five simply expire. There is nothing to exchange them for.",
        "A fresh application, before the date. After the date the client has nothing.",

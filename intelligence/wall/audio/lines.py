...
WALLS = {
    ...
    'permanent': [                               # The Permanent Book
        ...
        "No life cover on this screen ends on a date. That is the whole reason it is not on the last one.",
        ...
        "The ones whose premium is paid to sixty-five are the gold figure. Those are the policies that run out of road.",
        "They can be extended. Not for nothing, though. It takes an additional premium.",
        "Underwriting happens on the increase only, at the age the client is today, and Guardian carries the cost of it.",
        "No more than three months in arrears, the original sum assured kept, and never below the company minimum.",
        "Rejuvenator is the critical illness cover, and the riders ride whatever they are attached to.",
        "Every rider has an expiry of its own, though. That is the screen after this one.",

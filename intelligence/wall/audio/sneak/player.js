...
/* ── the bed ──
   ...
   FIVE chords: D F#m Bm G D. Five lands home on the last one at 43.5s, which
   is this film — the same 8.7s chord as every other branch film, just fewer of
   them. Do not shorten the chord to fit; shorten the film.
...
function startMusic(){
  ...
  try{
    ...
    at(0.34, 0, 1.6);  at(0.34, 2.2); at(0.18, 3.6);
    at(0.18,25.0); at(0.40,26.4); at(0.40,30.6); at(0.20,32.0);
    at(0.20,37.4); at(0.46,38.8); at(0.46,42.0); at(0.0, 43.3);
    music={bus,lp};

...
function pdWrap_(inner, tag, internal) {
  var isFl = tag && String(tag.kind || '').indexOf('fl_') === 0;
  var foot = internal
    ...
    : isFl
    ? 'This notice relates to the delivery of your policy documents and your free-look provision. Your policy ' +
      'contract and schedule govern in all cases, including the exact free-look terms. If your policy is already ' +
      'in your hands and acknowledged, please ignore this — records can take a few days to reflect.'

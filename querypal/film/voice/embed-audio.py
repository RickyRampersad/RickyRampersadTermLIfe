#!/usr/bin/env python3
"""Fold the narration MP3s into story-film.html as data URIs.
...
film = here.parent / 'story-film.html'
...
if start not in html or end not in html:
    sys.exit('Markers missing in story-film.html — nothing was changed.')
...
print(f'story-film.html is now {len(html)/1024:.0f} KB')
